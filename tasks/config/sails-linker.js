...
module.exports = function(grunt) {
  ...
  grunt.config.set('sails-linker', {
    ...
    devJsPrivate: {
      options: {
        startTag: '// SCRIPTS PRIVATE',
        endTag: '// SCRIPTS PRIVATE END',
        fileTmpl: 'script(src="%s")',
        appRoot: '.tmp/public'
      },
      files: {
        '.tmp/public/**/*.html': require('../pipeline').jsPrivateFilesToInject,
        'views/**/*.html': require('../pipeline').jsPrivateFilesToInject,
        'views/**/*.jade': require('../pipeline').jsPrivateFilesToInject
      }
    },
    ...
    prodJsPrivate: {
      options: {
        startTag: '// SCRIPTS PRIVATE',
        endTag: '// SCRIPTS PRIVATE END',
        fileTmpl: 'script(src="%s?cachebuster='+new Date().getTime()+'")',
        appRoot: '.tmp/public'
      },
      files: {
        '.tmp/public/**/*.html': ['.tmp/public/min/productionPrivate.min.js'],
        'views/**/*.html': ['.tmp/public/min/productionPrivate.min.js'],
        'views/**/*.jade': ['.tmp/public/min/productionPrivate.min.js']
      }
    },
    ...
    prodStylesJade: {
      options: {
        startTag: '// STYLES',
        endTag: '// STYLES END',
        fileTmpl: 'link(rel="stylesheet", href="%s?cachebuster='+new Date().getTime()+'")',
        appRoot: '.tmp/public'
      },
      files: {
